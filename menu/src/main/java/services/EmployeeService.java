...
public class EmployeeService {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Employee sampleEmployee = employeeService.sample();
            Employee employee = employeeService.getEmployeeById(1);
            if (employee != null) {
                employeeService.insertEmployee(sampleEmployee);
            }
            sampleEmployee.setBloodType("AB+");
            sampleEmployee.setEmployeeId(2);
            System.out.println(employeeService.updateEmployee(sampleEmployee));
            Statement stmt = connection.createStatement();
            ResultSet rs = stmt.executeQuery(select);
            
            while (rs.next()) {
                System.out.println("Employee ID: " + rs.getInt("employee_id"));
                System.out.println("Company Employee ID: " + rs.getString("company_employee_id"));
                System.out.println("Last Name: " + rs.getString("last_name"));
                System.out.println("First Name: " + rs.getString("first_name"));
                System.out.println("Middle Name: " + rs.getString("middle_name"));
                System.out.println("Suffix: " + rs.getString("suffix"));
                System.out.println("Contact Number: " + rs.getString("contact_number_primary"));
                System.out.println("Email: " + rs.getString("email_address")); 
                System.out.println("Current Address: " + rs.getString("current_address"));
                System.out.println("Home Address: " + rs.getString("home_address"));
                ...
                System.out.println("Number of Siblings: " + rs.getInt("number_of_siblings"));
                System.out.println("Hire Date: " + rs.getDate("hire_date"));
                System.out.println("Regularization Date: " + rs.getDate("regularization_date"));
                System.out.println("Employment Status: " + rs.getString("employment_status"));
                System.out.println("SSS Number: " + rs.getString("sss_number"));
                System.out.println("PhilHealth Number: " + rs.getString("philhealth_number")); 
                System.out.println("TIN Number: " + rs.getString("tin_number"));
                System.out.println("Pag-IBIG Number: " + rs.getString("pagibig_number"));
                System.out.println("Father's Name: " + rs.getString("father_full_name"));
                System.out.println("Father's DOB: " + rs.getDate("father_DOB"));
                System.out.println("Father's SSS: " + rs.getString("father_sss_number"));
                System.out.println("Mother's Name: " + rs.getString("mother_full_name")); 
                System.out.println("Mother's DOB: " + rs.getDate("mother_DOB"));
                ...
                System.out.println("Emergency Contact Address: " + rs.getString("emergency_contact_address"));
                System.out.println("Emergency Contact Number: " + rs.getString("emergency_contact_number"));
                System.out.println("Department ID: " + rs.getInt("current_department_id"));
                System.out.println("Position ID: " + rs.getInt("current_position_id"));
                System.out.println("Created At:" + rs.getDate("created_at"));
                System.out.println("Created At:" + rs.getDate("updated_at"));
                System.out.println("------------------------");
            }
    ...
    private Employee sample() {
        ...
        employee.setEmployeeCode("12345");
        employee.setLastName("Doe"); 
        employee.setFirstName("John");
        employee.setMiddleName("Doe");
        employee.setSuffix("III");
        employee.setContactNumberPrimary("1234567890");
        employee.setEmailAddress("john.doe@example.com");
        employee.setCurrentAddress("123 Main St");
        employee.setHomeAddress("456 Home St");
        employee.setDateOfBirth(new java.sql.Date(System.currentTimeMillis()));
        employee.setPlaceOfBirth("New York");
        employee.setGender("Male");
        employee.setCivilStatus("Single");
        employee.setBloodType("O");
        employee.setHireDate(new java.sql.Date(System.currentTimeMillis()));
        employee.setRegularizationDate(new java.sql.Date(System.currentTimeMillis()));
        employee.setSSSNumber("1234567890");
        employee.setPHICNumber("1234567890"); 
        employee.setTIN("1234567890");
        employee.setHDMFNo("1234567890");
        ...
        emergencyContact.setAddress("789 Emergency St");
        emergencyContact.setContactNumber("9876543210");
